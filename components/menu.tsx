                    ...
                    <div className="bg-white p-10 rounded-3xl bg-opacity-50">
                        ...
                        >
                            ...
                            <a
                                href="#"
                                onClick={() => {
                                    setShowSaveGameInput(false);
                                    setShowMainMenu(true);
                                    props.saveGame(newGameName);
                                }}
                            >
                                Save!
                            </a>
                        ...
                        <div className={showMainMenu ? "" : "hidden"}>
                            <div
                                className="pl-5 text-lg lg:text-2xl xl:text-2xl 2xl:text-2xl text-left"
                                style={{ fontFamily: "Roboto Mono" }}
                            >
                                <a
                                    href="#"
