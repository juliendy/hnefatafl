...
export default function Board(props: {
    ...
    const getProperStyle = (item: number, row: number, col: number) => {
        // basic styling
        let styles = `shadow-md duration-75 ease-in
        ...
        if (
            ...
            ((row == 0 && col == 0) ||
                ...
                (row == props.stones.length - 1 &&
                    col == props.stones.length - 1) ||
                (row == props.stones.length - 1 && col == 0) ||
                (row == (props.stones.length - 1) / 2 &&
                    col == (props.stones.length - 1) / 2))
        )
