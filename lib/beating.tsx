...
function checkKingThreeSidesAndThrone(
    ...
    // above throne
    if (
        kingPos.row == (stones.length - 1) / 2 - 1 &&
    ...
    // left of throne
    if (
        kingPos.col == (stones.length - 1) / 2 - 1 &&
        stones[kingPos.row - 1][kingPos.col] == 2 &&
        stones[kingPos.row + 1][kingPos.col] == 2 &&
        stones[kingPos.row][kingPos.col + 1] == 2
    ) {
    ...
    function checkBeatingWithEmptyThrone(
        stones: number[][],
        whichTeamIsOn: number,
        newStone: Stone
    ) {
        ...
        if (newStone.row > 1) {
            if (
                stones[newStone.row - 1][newStone.col] == enemy &&
                stones[newStone.row - 2][newStone.col] == 0 &&
                newStone.row - 2 == (stones.length - 1) / 2 &&
                newStone.col == (stones.length - 1) / 2
            ) {
        ...
        if (newStone.col > 1) {
            if (
                stones[newStone.row][newStone.col - 1] == enemy &&
                stones[newStone.row][newStone.col - 2] == 0 &&
                newStone.col - 2 == (stones.length - 1) / 2 &&
                newStone.row == (stones.length - 1) / 2
            ) {
    ...
    // if so, remove enemy stone
    function checkBeatingWithCorner(
        stones: number[][],
        whichTeamIsOn: number,
        newStone: Stone
    ) {
        ...
        if (newStone.row < stones.length - 2) {
            if (
                stones[newStone.row + 1][newStone.col] == enemy &&
                stones[newStone.row + 2][newStone.col] == 0 &&
                newStone.row + 2 == stones.length - 1 &&
                (newStone.col == 0 || newStone.col == stones.length - 1)
            ) {
                stones[newStone.row + 1][newStone.col] = 0;
            }
